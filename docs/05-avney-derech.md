...
| R10 | ציר zgyro משודר קפוא (v1.0.3385); ‏baro/mag = NaN | ‏yaw מג'ירו לא זמין → פיצוי NED והחיפוש נשענים על ציר מת | בדיקות חיות עברו לרב-צירי; אם zgyro קפוא גם בטיסה — ‏yaw מראייה (מעקב שער) במקום אינטגרציית ג'ירו | ממתין לטיסה אמיתית (Phase 1f) |
