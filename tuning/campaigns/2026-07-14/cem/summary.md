...
Abort reasons:
- `environment collision (impulse=3.6)`: 1
- `environment collision (impulse=4.1)`: 1
- `environment collision (impulse=4.2)`: 1
- `environment collision (impulse=4.4)`: 1
- `environment collision (impulse=4.5)`: 3
- `environment collision (impulse=4.6)`: 1
- `environment collision (impulse=4.8)`: 1
- `environment collision (impulse=4.9)`: 3
- `environment collision (impulse=5.0)`: 1
- `environment collision (impulse=5.1)`: 5
- `environment collision (impulse=5.2)`: 3
- `environment collision (impulse=5.3)`: 1
- `environment collision (impulse=5.4)`: 1
- `environment collision (impulse=5.5)`: 2
- `environment collision (impulse=5.6)`: 1
- `environment collision (impulse=5.7)`: 4
- `environment collision (impulse=5.9)`: 1
- `environment collision (impulse=6.0)`: 3
- `environment collision (impulse=6.1)`: 3
- `environment collision (impulse=6.2)`: 1
- `environment collision (impulse=6.8)`: 1
